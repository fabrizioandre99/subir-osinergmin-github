...
public class AdmTipoSistTransDTO {
    ...
    public AdmTipoSistTransDTO(Integer idTipoSisTrans, String codTipoSisTrans, String tipSisTrans, String estado) {
        this.idTipoSisTrans = idTipoSisTrans;
        this.codTipoSisTrans = codTipoSisTrans;
        this.tipSisTrans = tipSisTrans;
        this.estado = estado;
